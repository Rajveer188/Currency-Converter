...
//    float rupee;
    ...
    private void rupeeToDollar(int INR) {
        float exchangeRate = 82.55f; // Current exchange rate between INR and USD.
        System.out.println(INR +" rupee in Dollar is "+String.format("%.2f", INR / exchangeRate)+"$");
    }

    private void rupeeToEuro(int INR) {
        float exchangeRate = 89.11f; // Current exchange rate between INR and EUR.
//        System.out.println(String.format("%.2f", INR / exchangeRate));
    ...
    private void rupeeToDinar(int INR) {
        float exchangeRate = 267.77f; // Current exchange rate between INR and AED.
//        System.out.println(String.format("%.2f", INR / exchangeRate));
    ...
    private void rupeeToPound(int INR) {
        float exchangeRate = 103.85f; // Current exchange rate between INR and GBP.
//        System.out.println(String.format("%.2f", INR / exchangeRate));
    ...
    private void rupeeToDirham(int INR) {
        float exchangeRate = 22.47f; // Current exchange rate between INR and AED.
//        System.out.println(String.format("%.2f", INR / exchangeRate));
